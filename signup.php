...
if(isset($_POST["create_user"]))
{
    ...
    $project_check = "SELECT * FROM user WHERE projectName = '$projectname'";
    $res = mysqli_query($con, $email_check);
    if(mysqli_num_rows($res) > 0){
      echo $errors['email'] = "Email that you have entered already exist!";
    }
    if(count($errors) === 0){
    ...
    if($con->query($sql))
	{
    echo "<script type='text/javascript'>alert('You have successfully registered! Continue to explore the site or click the dashboard on the navigation bar to update your profile or create and edit an article.'); window.location.href = 'signin.php';</script>";
	}else{
