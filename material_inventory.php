...
<?php
$sql="select material_inventory.*,materials.materials from material_inventory,materials where material_inventory.material_id=materials.id order by material_inventory.id desc";
