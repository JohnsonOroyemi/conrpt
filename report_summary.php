...
<?php
$sql="select work_accomplished.*,work_activities.work_activities from work_accomplished,work_activities where work_accomplished.work_activities_id=work_activities.id and date (date) = date(now()) order by work_accomplished.id asc";
$res=mysqli_query($con,$sql);
?>
...
<?php
$sql="select material_inventory.*,materials.materials from material_inventory,materials where material_inventory.material_id=materials.id and date (date) = date(now()) order by material_inventory.id asc";
$res=mysqli_query($con,$sql);
?>
